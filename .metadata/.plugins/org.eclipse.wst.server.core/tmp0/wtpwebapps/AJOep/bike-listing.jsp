        ...
        <div class="result-sorting-wrapper">
          <div class="sorting-count">
			...
			<p><span> ${ result.rowCount } Listings</span></p>
		 	...
		 	<sql:query dataSource="${db}" var="result">SELECT tblvehicles.VehiclesTitle,tblbrands.BrandName,tblvehicles.PricePerDay,tblvehicles.FuelType,tblvehicles.ModelYear,tblvehicles.id,tblvehicles.SeatingCapacity,tblvehicles.VehiclesOverview,tblvehicles.Vimage1 from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand;</sql:query>
			<c:forEach var = "row" items = "${result.rows}">

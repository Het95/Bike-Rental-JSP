...
<title>Bike Rental Portal | My bookings</title>
<!--Bootstrap -->
        ...
        <div class="profile_wrap">
          ...
          <div class="my_vehicles_list">
            <ul class="vehicle_listing">
            	  ...
            	  <sql:query dataSource = "${db}" var = "result">
        		SELECT tblvehicles.Vimage1 as Vimage1,tblvehicles.VehiclesTitle,tblvehicles.id,tblbrands.BrandName,tblbooking.FromDate,tblbooking.ToDate,tblbooking.message,tblbooking.Status  from tblbooking join tblvehicles on tblbooking.VehicleId=tblvehicles.id join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand where tblbooking.userEmail='${ sessionScope.userMail }';
        	    </sql:query>
        	     <c:forEach var = "row" items = "${result.rows}">
            	<li>
            		  <div class="vehicle_img"> <a href="vehical-details.php?vhid=${row.id }"><img src="admin/img/vehicleimages/${row.Vimage1 }" alt="image"></a> </div>
                <div class="vehicle_title">
                  <h6><a href="vehical-details.php?vhid=${row.id }"> ${row.BrandName } ,${row.VehiclesTitle }</a></h6>
                  <p><b>From Date:</b> ${row.FromDate }<br /> <b>To Date:</b> ${row.ToDate }</p>
                </div>
            		<c:choose>
            ...
            <div class="clearfix"></div>
				 ...
				 <div style="float: left"><p><b>Message:</b> ${  row.message}</p></div>
              </li>
            	</c:forEach>

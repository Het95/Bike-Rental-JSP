...
<title>Bike Rental Portal | Contact US</title>
      ...
      <div class="col-md-6">
        ...
        <div class="contact_detail">
           <sql:query dataSource = "${db}" var = "result">
        	    	SELECT Address,EmailId,ContactNo from tblcontactusinfo;
        	    </sql:query>
        	     <c:forEach var = "row" items = "${result.rows}">
        	     <ul>
            <li>
              <div class="icon_wrap"><i class="fa fa-map-marker" aria-hidden="true"></i></div>
              <div class="contact_info_m">${ row.Address } </div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-phone" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="tel:">${ row.EmailId }</a></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-envelope-o" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="mailto:">${ row.ContactNo }</a></div>
            </li>
          </ul>
        	  </c:forEach>
 </div>
